...
const firebaseInitGlobals = {
  ...
  getProject: 'readonly',
  getElectricalDrawing: 'readonly',
  listElectricalDrawingsForProject: 'readonly',
  saveElectricalDrawing: 'readonly',
  ...
  ensureServiceProducts: 'readonly',
  ...
  listProductConfigs: 'readonly',
  getProductConfig: 'readonly',
  createProductConfig: 'readonly',
  updateProductConfig: 'readonly',
  deleteProductConfig: 'readonly',
  toggleProductConfigActive: 'readonly',
...
export default [
  ...
  // ── Browser ES-module source files (calc-engine, csv, shared-helpers) ─────
  {
    files: [
      ...
      'assets/js/project-documents.js',
